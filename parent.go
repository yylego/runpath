...
//
// NOTE: These methods consume one stack frame due to the method invocation itself.
// In shallow-stack scenarios (e.g., package-level variable init), use
// filepath.Dir(runpath.Skip(n)) instead, which is a package-level function and
